...
public class MethodCreation {
    ...
    public static void main(String[] args) {
        ...
        //sout yazip "Enter" a basiniz Sysyem.out.println() otomatik olarak yazilir.
        //Ekrana bir sey yazdirmak icin iki tane kod var:
        // i)System.out.println() ==> Satirbasi yapar
        // ii)Sysyem.out.print() ==> Satirbasi yapmaz/ Yan yana yazdirir
   ...
   // Example 2: Uc sayiyi birbiri ile carpan bir method olusturunuz
    ...
    //Example 3: Uc sayidan ilk ikisini toplayip ucuncu ile carpan method olsuturup, sonucu ekrana yazdırınız.
