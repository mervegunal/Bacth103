...
public class MultiDimensionalArrays01 {
    ...
    public static void main(String[] args) {
        ...
        //Multidimensional Array'lere eleman ekleme nasıl yapilir?
        arr[1][0] = 6;
        arr[0][0] = 3;
        arr[0][1] = -4;
        arr[1][1] = 18;
        ...
        //Multimensional Array console'a nasil yazdirilir?
        System.out.println(Arrays.deepToString(arr)); //

        //Multimensional Array lerde Array elemanlardan biri nasil yazdirilir?
        System.out.println(Arrays.toString(arr[1]));

        //Multimesional Arraylerde ic Array'lerdeki elemanlar nasil yazdirilir?
