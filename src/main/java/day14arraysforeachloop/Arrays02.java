...
public class Arrays02 {
    public static void main(String[] args) {
        ...
        int yeni[] = new int[original.length]; //[2, 3, 12, 0, 0, 0] (eleman sayisi orjinaldeki kadar olsun diye length kullandik)
       ...
       // Example 2: Bir Arrayin icinde herhangi bir elemanin olup olmadigini kontrol eden ve kac kere tekrarlandigini gosteren kodu yaziniz.
        ...
        System.out.println(sentence); //Noktalama isaretlerini kaldirdik

        String words[] = sentence.split(" "); //[Java, kolaydir, calisana, ne, kolay, ki, calismayana]
