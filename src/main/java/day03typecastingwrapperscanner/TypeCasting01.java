...
public class TypeCasting01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(newPrice);//12 ==> Java ondalık sayıyı tam sayıya cevirirken yuvarlama islemi yapmaz
                                     //       Java ondalık sayiyi, tam sayiya cevirirken ondalik kismini siler.

        int number = 515;
        byte newNumber = (byte)number;
        System.out.println(newNumber);//3 ==> Java 515'i 256(byte daki sayilarin sayisi) ya boldu kalanı return etti.
