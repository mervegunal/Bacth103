...
public class WrapperClass01 {
    public static void main(String[] args) {
        ...
        yapi olusturdu, bu yapi "Wrapper Class"
        ...
        */
        byte primitiveByte = 12;//"primitiveByte" yazip nokta koydugunuzda hic method goremezsınız, cunku primitive'ler method icermez sadece deger icerir
        ...
        //Example 2: short, int, long data type'lerinin en buyuk ve en kucuk degerlerini yazdırınız.
